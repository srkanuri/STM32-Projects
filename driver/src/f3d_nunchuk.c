 ...
 *           By: Rahgavendra Nataraj(natarajr), Srikanth Kanuri(srkanuri)
 *     Update #: 0
 * Keywords: 
 * Compatibility: 
 * 
...
#define NUNCHUK1_ADDRESS 0xA4
#define NUNCHUK2_ADDRESS 0xA5
...
void f3d_nunchuk_init(void) {
 ...
 f3d_i2c1_write(NUNCHUK1_ADDRESS,0xf0,&buf); 
  f3d_i2c1_write(NUNCHUK1_ADDRESS,0xfb,&buf2);
  //f3d_i2c2_write(NUNCHUK2_ADDRESS,0xf0,&buf); 
  //f3d_i2c2_write(NUNCHUK2_ADDRESS,0xfb,&buf2);
}
